...
// DiskIamageStore stores images on disk and its info on memory
...
// NewDiskIamgeStore returns a new DiskImageStore
func NewDiskIamgeStore(imageFolder string) *DiskImageStore {
